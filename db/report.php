...
<body>
  <form method="get" action="">
    ...
    <div id="start">
      ...
      <div>
        <input type="text" name="head[]" value="head1">
      </div>
      <div class="item">
        <p>Detail</p>
        <div class="name-item">
          ...
          <!-- summernote -->
          <textarea id="summernote" name="summernote[]" rows="4" cols="50">Hello Summernote1</textarea>
    ...
    <div id="start">
      ...
      <div>
      <input type="text" name="head[]" value="head2">
      </div>
      <div class="item">
        <p>Detail</p>
        <div class="name-item">
          ...
          <div id="editor" name="editor"></div> -->
          <!-- summernote -->
          <textarea id="summernote" name="summernote[]" rows="4" cols="50">Hello Summernote2</textarea>
